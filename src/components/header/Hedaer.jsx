    ...
    return (
        <header className='header'>
            ...
            <div className="modal-view">
                <button onClick={toggleShowModal} className='btn-view'> {view} </button>
                {showModal && <div className='modal-view-show'>
                    <NavLink onClick={toggleShowModal} to={{pathname:'/calendar/month', state:{show:"month", ru:'Месяц'}}}>Месяц</NavLink>
                    <NavLink onClick={toggleShowModal} to={{pathname:'/calendar/week', state:{show:"week", ru:'Неделя'}}}>Неделя</NavLink>
                </div>}
            </div>
        </header>
    )
